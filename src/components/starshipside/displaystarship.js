...
export default function DisplayStarships() {
                            ...
                            <div className="col-7">     
                                <div className="list-group">
                                    <ul className="list-group list-group-flush">
                                        ...
                                        <li className="list-group-item"> <h5>Hiperdrive Rating: {store.current.hyperdrive_rating} </h5>  </li>
                                        <li className="list-group-item"> <h5>Starship Class: {store.current.starship_class} </h5>  </li>
                                    </ul>
                                </div>
                            </div>
                            <div className="col-4">
                            <img className="mx-2 mt-5" src={`./Spaceships/${store.current.name}.jpg`} width="250px" height="250px" alt={store.current.name} />
                            </div>
                        </div>
                    </div>
                </div>
