...
export default function CardVehicles(props) {
    ...
    return (
        <div className="card m-3 mx-1 ">
            ...
            <img className="mx-2" src={`./Vehicles/${props.name}.jpg`} width="250px" height="250px" alt={props.name} />
            </div>
                <ul className="list-group">
                    ...
                    <li key="3" className="list-group-item"><h6>Max speed: </h6> {props.speed} km/h</li>
